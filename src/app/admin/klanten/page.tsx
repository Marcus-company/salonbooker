              ...
              <tr key={customer.id} className="hover:bg-slate-50">
                ...
                <td className="px-6 py-4">
                  <div className="flex gap-2">
                    <Link
                      href={`/admin/bookingen?phone=${encodeURIComponent(customer.phone)}`}
        ...
        {filteredCustomers.map((customer) => (
          <div key={customer.id} className="bg-white rounded-xl shadow-sm border border-slate-200 p-4">
            ...
            <div className="flex gap-2">
              <Link
                href={`/admin/bookingen?phone=${encodeURIComponent(customer.phone)}`}
                className="flex-1 px-3 py-2 text-sm bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors text-center"
              >
                Geschiedenis
              </Link>
              <Link
